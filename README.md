...
| Хаб: аккаунты, приглашения, проекты | `apps/hub` | ✅ ноль зависимостей, 42 теста |
| Провайдеры: ключ и делегированный CLI | `packages/agents` | ✅ 38 тестов |
| Рабочая папка и история разговора | `apps/desktop/src/main` | ✅ 21 тест |
...
| Репозиторий проекта на хабе | — | ⬜ таблицы есть, bare repo и клиент нет |
